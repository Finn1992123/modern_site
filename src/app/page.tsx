      ...
      <section id="top" className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.lead}>
            Η εκμάθηση ξένων γλωσσών γίνεται απλά, οργανωμένα και με φροντίδα.
            Στηρίζουμε κάθε μαθητή βήμα-βήμα, με σύγχρονα εργαλεία, σταθερή
            πρόοδο και προετοιμασία για πιστοποιήσεις.
          </p>
